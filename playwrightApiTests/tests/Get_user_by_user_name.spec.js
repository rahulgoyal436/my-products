...
RoostTestHash=/user/{username}f17de7b32a
...
test("Get user by user name", async () => {
  ...
  const csvFilePath = `/var/tmp/Roost/RoostGPT/roost_test/1732294863/source/my-products/playwrightApiTests/tests/Get_user_by_user_name.csv`
