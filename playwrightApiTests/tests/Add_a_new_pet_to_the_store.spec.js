...
test("Add a new pet to the store", async () => {
  ...
  const csvFilePath = `/var/tmp/Roost/RoostGPT/roost_test/1732294863/source/my-products/playwrightApiTests/tests/Add_a_new_pet_to_the_store.csv`
