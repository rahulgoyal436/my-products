...
RoostTestHash=/user/{username}-delete-0a0349d0fb
...
test("Delete user", async () => {
  ...
  const csvFilePath = `/var/tmp/Roost/RoostGPT/roost_test/1732295204/source/my-products/playwrightApiTests/tests/Delete_user.csv`
