...
RoostTestHash=/pet/{petId}f0e68c4b69
...
test("Deletes a pet", async () => {
  ...
  const csvFilePath = `/var/tmp/Roost/RoostGPT/roost_test/1732294863/source/my-products/playwrightApiTests/tests/Deletes_a_pet.csv`
