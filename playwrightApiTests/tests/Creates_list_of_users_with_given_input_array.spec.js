...
test("Creates list of users with given input array", async () => {
  ...
  const csvFilePath = `/var/tmp/Roost/RoostGPT/roost_test/1732295381/source/my-products/playwrightApiTests/tests/Creates_list_of_users_with_given_input_array.csv`
