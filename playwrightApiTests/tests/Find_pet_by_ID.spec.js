...
RoostTestHash=/pet/{petId}-get-938ff327e6
...
test("Find pet by ID", async () => {
  ...
  const csvFilePath = `/var/tmp/Roost/RoostGPT/roost_test/1732295204/source/my-products/playwrightApiTests/tests/Find_pet_by_ID.csv`
