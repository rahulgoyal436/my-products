...
RoostTestHash=/user/{username}bd81865868
...
test("Updated user", async () => {
  ...
  const csvFilePath = `/var/tmp/Roost/RoostGPT/roost_test/1732294863/source/my-products/playwrightApiTests/tests/Updated_user.csv`
