...
RoostTestHash=/pet/{petId}/uploadImagecf10b7ae90
...
test("uploads an image", async () => {
  ...
  const csvFilePath = `/var/tmp/Roost/RoostGPT/roost_test/1732294863/source/my-products/playwrightApiTests/tests/uploads_an_image.csv`
