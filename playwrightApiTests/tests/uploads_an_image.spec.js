...
RoostTestHash=/pet/{petId}/uploadImage-post-60313d8c5e
...
test("uploads an image", async () => {
  ...
  const csvFilePath = `/var/tmp/Roost/RoostGPT/roost_test/1732295381/source/my-products/playwrightApiTests/tests/uploads_an_image.csv`
